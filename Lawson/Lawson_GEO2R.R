...
# R scripts generated  Wed Oct 14 01:30:08 EDT 2015
...
gset <- getGEO("GSE70555", GSEMatrix =TRUE)
if (length(gset) > 1) idx <- grep("GPL20665", attr(gset, "names")) else idx <- 1
gset <- gset[[idx]]
...
title <- paste ("GSE70555", '/', annotation(gset), " selected samples", sep ='')
